...
Consider the matrix digraph in Fig. \ref{fig:3digraph}.  To factor the determinant of the corresponding matrix (Eq. (\ref{eq:A})), first create a digraph $G_1$ that is explicitly rooted at vertex $1$ and a digraph ${\bar G}_1$ that is explicitly not rooted at vertex $1$.  $G_1$ is shown in Fig. \ref{fig:g1}(a).  Then isolate vertex $1$ by moving the arcs $(1,2)$ and $(1,3)$ to $(0, 2)$ and $(0, 3)$, respectively, and combining with the existing arcs.  This results in the digraph in Fig. \ref{fig:g1}(b).
...
\centering 
  ...
  \centering
    ...
    \draw[->, black] (3) edge [bend right] node [left, below right, pos = 0.6] {$v_{23}$} (4);
    \end{tikzpicture} 
    \caption{$G_1$ after isolation.}
    \end{subfigure}

    \caption{Digraph $G_1$ explicitly rooted at vertex $1$.}\label{fig:g1}
\end{figure}
...
\centering 
  ...
  \centering
    ...
    \end{tikzpicture} 
    \caption{$G_{2,1}$ after isolation.}
  \end{subfigure} 
  \hspace{6em}
  \begin{subfigure}[b]{0.25\textwidth}
  \centering
    ...
    \end{tikzpicture} 
    \caption{$G_{2,3}$ after isolation.} 
    \end{subfigure}

    \caption{Fully isolated $G_2$ digraphs.  (a) $W(B) = (v_{21}+v_{31})(v_{22})(v_{33} + v_{23})$. (b) $W(B) =v_{21}v_{22}v_{13}$.}\label{fig:g2}
\end{figure}

Similarly follow the isolation procedure for $G_3$ to obtain the digraphs in Fig. \ref{fig:g3}.
...
\centering 
  ...
  \centering
    ...
    \end{tikzpicture} 
    \caption{$G_{3,1}$ after isolation.}
  \end{subfigure} 
  \hspace{6em}
  \begin{subfigure}[b]{0.25\textwidth}
  \centering
    ...
    \end{tikzpicture} 
    \caption{$G_{3,2}$ after isolation.}
    \end{subfigure}

    \caption{Fully isolated $G_3$ digraphs.  (a) $W(B) = v_{31}(v_{12}+v_{32})v_{33}$.  (b) $W(B) = v_{21}v_{32}v_{33}$.} \label{fig:g3}
\end{figure}
